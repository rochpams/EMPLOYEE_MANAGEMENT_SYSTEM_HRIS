        ...
        <section class="hris-hero">
            <div class="hris-hero-grid">
                ...
                <div class="d-flex flex-wrap gap-2">
                    <a href="{{ route('reports.export', ['type' => 'activity', 'format' => 'csv', 'month' => request('month'), 'year' => request('year')]) }}" class="hris-btn-secondary">CSV Export</a>
                    <a href="{{ route('reports.export', ['type' => 'activity', 'format' => 'pdf', 'month' => request('month'), 'year' => request('year')]) }}" class="hris-btn-primary">PDF Export</a>
